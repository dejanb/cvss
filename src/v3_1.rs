//! Represents the CVSS v3.1 specification.

use serde::{Deserialize, Serialize};

/// Represents a CVSS v3.1 score object.
...
mod tests {
    ...
    fn test_deserialize_v3_1() {
        let cvss: CvssV3_1 = serde_json::from_str(SAMPLE_JSON).unwrap();
        assert_eq!(cvss, sample_cvss_v3_1());
    }

    #[test]
    fn test_serialize_v3_1() {
        let cvss = sample_cvss_v3_1();
    ...
    #[test]
    fn test_roundtrip_v3_1() {
        let cvss: CvssV3_1 = serde_json::from_str(SAMPLE_JSON).unwrap();
        let json = serde_json::to_string(&cvss).unwrap();
        let cvss_rt: CvssV3_1 = serde_json::from_str(&json).unwrap();
